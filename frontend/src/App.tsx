...
function MobileQuickActions() {
  ...
  return (
    <div className="mobile-quick-actions fixed right-4 z-40 lg:hidden">
      <button
        type="button"
        aria-label="新增交易"
  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <div className={cn("transition-all duration-300", compact ? "lg:pl-[86px]" : "lg:pl-[250px]")}>
        ...
        <GlobalOwnerBar />
        <main className="mx-auto min-h-screen max-w-[1600px] px-4 pb-20 pt-7 sm:px-7 lg:px-10 lg:py-9">
          <Suspense
            fallback={
